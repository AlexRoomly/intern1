...
- Запрашивает необходимость расчета индикаторов MACD, предоставляет возможность выбрать стиль оформления графика.
...
10. Программа позволяет выбрать стиль оформления графика.

<p align="center">
<img src="Picture/img9.png" width="80%">
</p>
